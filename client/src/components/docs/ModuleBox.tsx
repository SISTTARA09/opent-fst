...
const ModuleBox = ({ module }: BoxParams): JSX.Element => {
	return (
		<div
      ...
      sm:hover:-translate-y-1 duration-200 ease-linear"
       ...
       before:absolute before:h-full before:w-[130%] before:top-0 before:left-0 before:bg-stone-900 before:z-[-1]"
				...
				<span className="absolute font-bold text-lg group-hover:animate-bounce ease-linear right-2 top-1/2 -translate-y-1/2 ">
